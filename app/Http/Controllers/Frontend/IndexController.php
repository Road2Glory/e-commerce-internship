...
class IndexController extends Controller
{
    ...
    public function productDetails($id,$slug){
        ...
        return view('frontend.product.product_details',compact('product','multiImg','color_en','product_color_en','color_fr','product_color_fr','size_en','product_size_en','size_fr','product_size_fr','relatedProduct'));
    }
