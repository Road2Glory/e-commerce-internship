...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">{!! $products->short_descp_en !!}</textarea>
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_fr" id="textarea" class="form-control" required placeholder="Textarea text">{!! $products->short_descp_fr !!}</textarea>
	 		 </div>
		</div>
...
<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Product">
        ...
        {{------- END SECTION Multiple Image Update Zone --------}}

        {{------- Start SECTION thumbnail Image Update Zone --------}}
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                      ...
                      <form method="post" action="{{ route('update-product-thumbnail') }}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id" value="{{ $products->id }}">
                        <input type="hidden" name="old_img" value="{{ $products->products_thambnail }}">
        ...
        {{------- End SECTION thumbnail Image Update Zone --------}}
