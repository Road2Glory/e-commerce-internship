                         ...
                         <div class="row">  {{-- start 4th row --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_fr" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" value="Small,Meduim,Large" data-role="tagsinput" placeholder="add tags">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_fr" class="form-control" value="Small,Meduim,Large" data-role="tagsinput" placeholder="add tags">
                         ...
                         <div class="row">  {{-- start 5th row --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_fr" class="form-control" value="Small,Meduim,Large" data-role="tagsinput" placeholder="add tags">
