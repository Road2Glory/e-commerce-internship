...
<div class="row"> <!-- start 2nd row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Post Title Fr <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 6th row  -->
	...
	<div class="controls">
		<select name="category_id" class="form-control" required="" >
         ...
         <option value="{{ $post->id }}">{{ $post->blog_category_name_en }}</option>
			@endforeach
		</select>
		@error('category_id')
	 <span class="text-danger">{{ $message }}</span>
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea class="ckeditor" name="post_details_en" rows="10" cols="80" required="">
		Post Details English
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea class="ckeditor" name="post_details_fr" rows="10" cols="80">
		Post Details French
						</textarea>
	 		 </div>
		</div>
