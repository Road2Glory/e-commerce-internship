  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <div class="logo" style="margin-top:30px;"><img src="{{ public_path('frontend/assets/images/logo-dark.png') }}" alt="logo">
          <h2 style="color: green; font-size: 26px;display: inline;"><strong>hopIn Online Store</strong></h2>
        </div>
        </td>
        <td align="right">
            <pre class="font" >
               ShopIn Head Office
               Email:support@ShopIn.com <br>
               Mob: 0612345678 <br>
               Rabat 1207,Takaddoum:#4 <br>
