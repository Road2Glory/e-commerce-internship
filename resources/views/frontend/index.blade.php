                        ...
                        <div class="row product-micro-row">
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="#">@if (session()->get('language') == 'french') {{ $product->product_name_fr }} @else {{ $product->product_name_en }} @endif</a></h3>
...
@foreach ($categories as $category)
      ...
      @endphp
                          ...
                          <div class="action">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                ...
                                <button class="btn btn-primary icon" type="button" title="Wishlist" data-toggle="modal" data-target="#exampleModal" id="{{ $product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
          ...
          <!-- ============================================== FEATURED PRODUCTS : END ============================================== -->
                    ...
                    <!-- ====== skip products 0 PRODUCTS ============================================== -->


                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">@if (session()->get('language') == 'french') {{ $skip_category_0->category_name_fr }} @else {{ $skip_category_0->category_name_en }} @endif
                  ...
                  @endphp
                      ...
                      <!-- ============================================== skip0 PRODUCTS : END ============================================== -->
                         ...
                         <!-- ====== skip products 1 PRODUCTS ============================================== -->


                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">@if (session()->get('language') == 'french') {{ $skip_category_1->category_name_fr }} @else {{ $skip_category_1->category_name_en }} @endif
          ...
          <!-- ============================================== WIDE PRODUCTS : END ============================================== -->
                         ...
                         <!-- ====== skipbrand products 1 PRODUCTS ============================================== -->


                         <section class="section featured-product wow fadeInUp">
                            <h3 class="section-title">@if (session()->get('language') == 'french') {{ $skip_brand_1->brand_name_fr }} @else {{ $skip_brand_1->brand_name_eng }} @endif
                ...
                <div class="item">
                  <div class="blog-post">
                    ...
                    <div class="blog-post-info text-left">
                      <h3 class="name"><a href="#">@if(session()->get('language') == 'french') {{ $category->blog_category_name_fr }} @else {{ $category->blog_category_name_en }} @endif</a></h3>


                      <span class="info"> {{ Carbon\Carbon::parse($blog->created_at)->diffForHumans() }}</span>


                      <p class="text">@if(session()->get('language') == 'french') {!! Str::limit($blog->post_details_fr, 200 )  !!} @else {!! Str::limit($blog->post_details_en, 200 )  !!} @endif</p>
