            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Stock : <span class="badge badge-pill badge-success" id="avaible" style="background:green;color:whitesmoke;"></span>
                            <span class="badge badge-pill badge-danger" id="stockout" style="background:red;color:whitesmoke;"></span> </li>
                      </ul>
                </div>{{--//end col md 4 --}}
