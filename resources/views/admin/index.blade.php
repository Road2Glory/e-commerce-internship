                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">{{ count($pending) }} <small class="text-danger"><i class="fa fa-caret-up"></i> Order(s)</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table no-border">
                                ...
                                <tr class="text-uppercase bg-lightest">
                                    ...
                                    <th style="min-width: 150px"><span class="text-fade">Payement</span></th>
